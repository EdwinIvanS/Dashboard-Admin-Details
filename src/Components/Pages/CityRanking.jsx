            ...
            <table className="table align-middle table-nowrap">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <Progress value="82" color="secondary" className="bg-transparent progress-sm" size="sm"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <Progress value="70" color="danger" className="bg-transparent progress-sm" size="sm" />
                        </td>
                    </tr>
                </tbody>
            </table>
